...
public class RoverRunActivity extends Activity {
	...
	private void init(){
		...
		listKnowledges = DataForRun.getDataForRoverRun(mContext);
	...
	private void initGUI(){
		...
		btn_RoverForward.setText("Rover Forward");
		btn_RoverBack.setText("Rover Back");
		btn_RoverTurnLeft.setText("Rover Left");
		btn_RoverTurnRight.setText("Rover Right");
	}
	...
	private class KnowledgeAdapter extends PagerAdapter{
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			TextView txt_KnowledgeContent = (TextView)view.findViewById(R.id.txt_knowledge);
